...
const Banner = () => (
  <div className="helpfulLinks">
    <div className="helpfulLinks__header">
      Helpful Links
    </div>
    <div className="helpfulLinks__membership column">
      <Icon
        className="mr-md"
        glyph={IconAccountHelp}
        size={50}
      />
      <a
        className="helpfulLinks__link"
        href="/me"
      >Membership and account help</a>
    </div>
    <div className="helpfulLinks__patientGuide">
      <Icon
        className="mr-md"
        glyph={IconDownload}
        size={50}
