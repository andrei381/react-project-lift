      ...
      >
        ...
        <div className="row mb-mx">
          <div className="column shrink">
            <div className="businessReviewForm__ratingSection">
              <div className="row align-middle mb-md">
                <div className="businessReviewForm__ratingLabel column">Customer Service: </div>
              ...
              <div className="row align-middle mb-md">
                <div className="businessReviewForm__ratingLabel column">Price: </div>
                <div className="column align-left">
                  <StarRating
              ...
              <div className="row align-middle mb-md">
                <div className="businessReviewForm__ratingLabel column">Ordering Process: </div>
                <div className="column align-left">
                  <StarRating
              ...
              <div className="row align-middle">
                <div className="businessReviewForm__ratingLabel column">Delivery Speed: </div>
                <div className="column align-left">
                  <StarRating
